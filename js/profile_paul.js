...
function setNewCodeInstrux(num) {
    ...
    if (codename_encrypted == false) {
        converted_text = "";
        tempHTML = '	<div class="verdana_12pxB" id="display_codename">' + codenames[curr_codename] + '-' + codenameCounter + '</div>';
        tempHTML += '	<div id="encrypted_status" class="verdana_11px" style="padding-top:2px;"><em>Not Encrypted Yet</em></div>';
    }
    else {
        tempHTML = '	<div id="display_codename" class="verdana_12pxB">' + converted_text + '-' + codenameCounter + '</div>';

        tempHTML += '	<div id="encrypted_status" class="verdana_11px" style="padding-top:2px;"><em>Encrypted</em></div>';
    }

    tempHTML += '<div style="padding:10px 0px 5px 0px;"><a href="#" onclick="hideEncrypt(); getCodenames(); return false;" onmouseover="changeImages(\'btn_change\', \'images/btn_change_over.gif\'); return true;" onmouseout="changeImages(\'btn_change\', \'images/btn_change.gif\'); return true;"><img id="btn_change" name="btn_change" src="images/btn_change.gif" width="143" height="18" alt="Change" border="0" /></a></div>';
    tempHTML += '<div style="padding-bottom:10px;"><a href="#" onclick="encryptCodename(); return false;" onmouseover="changeImages(\'btn_encrypt2\', \'images/btn_encrypt2_over.gif\'); return true;" onmouseout="changeImages(\'btn_encrypt2\', \'images/btn_encrypt2.gif\'); return true;"><img id="btn_encrypt2" name="btn_encrypt2" src="images/btn_encrypt2.gif" width="143" height="18" alt="Encrypt" border="0" /></a></div>';
...
function checkKey(cipher_num) {
    if (cipher_num == 1) {
        //additive
        if (isNaN(document.formContainer['key_object1'].value * 1) || (document.formContainer['key_object1'].value * 1) > 25 || (document.formContainer['key_object1'].value * 1) < 0 || document.formContainer['key_object1'].value == "") {
            keyA = "";
        ...
        if (isNaN(document.formContainer['key_object2'].value * 1) || document.formContainer['key_object2'].value == "") {
            keyB = "";
...
function encryptName() {
    if (currCipher == 1 || currCipher == 3 || currCipher == 6 || currCipher == 7) {
        if (isNaN(keyA)==false || keyA=="") {
        ...
        if (isNaN(keyA)==false && isNaN(keyB)==false && keyA!="" && keyB!="") {
            converted_text = encryptText(codenames[curr_codename]);
        }
        else {
            return;
