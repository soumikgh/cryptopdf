        ...
        Created by: Ilya Gerasimenko | http://www.gerasimenko.com/ */
            ...
            function updateStep(num)
            {
                ...
                if (show_step==true)
                {
                    ...
                    else if (currMenu==3)
                    {
                        ...
                        tempHTML+='		<td class="header_step2R" style="padding:0px 3px 0px 3px;"><div class="helvetica11pxTanB">Is key<br />printed?</div></td>';
                        tempHTML+='	</tr>';
                        ...
                        for (i=1; i<total_fields+1; i++)
                        {
                            ...
                            else if (cipher_num[i]==2)
                            {
                                if (keyA[i]!=0)
                                {
                                    tempHTML+='Multiplicative Key = '+keyA[i]+'<br />';
                                    //paper code
                                    if (i==1){tempHTML2+='Multiplicative Key = '+keyA[i]+'<br />';}
                                }
                                else
                                {
                                    return;
                        ...
                        tempHTML2+='<div class="clue_text" style="padding:0px;"><br />'+converted_text_paper+'</div>';
            ...
            function updateCipher(object_id,num,reset_obj)
            {
                ...
                else if (num==2)
                {
                    ...
                    tempHTML+='<tr><td align="right"><em><strong>Additive (any number)</strong></em> </td><td><input type="text" id="step2_keyB'+object_id+'" maxlength="2" class="form_field11px" style="width:19px; height:12px; text-align:right; color:#000000;" value="'+keyB[object_id]+'" onkeyup="checkKey('+object_id+'); return false;" /></td></tr></table>';
                }
                else if (num==3)
                {
            ...
            function updateList(num)
            {
                if (num!=0)
                {
                    ...
                    tempHTML+='		<td class="header_step2R" style="padding:6px 11px 6px 11px;"><div class="helvetica11pxTanB">Is key<br />printed?</div></td>';
                    tempHTML+='	</tr>';
                    for (i=1; i<total_fields+1; i++)
                    {
                        tempHTML+='	<tr>';
                ...
                <div id="barT_internal">
                    <div id="content_main" align="left">
                        <div id="login_info"><strong class="yellow_arialB">UserName</strong><br />
                            <a href="#" onclick="logOut(); return false;" onkeypress="logOut(); return false;" class="arial_yellowB">Logout</a></div>
                                    ...
                                    <div id="hide2" class="generator240_columnRM">
                                        ...
                                        <div id="sample_school1">
                                            ...
                                            <div id="sample_schooltext1">
                                                <div class="sample_text">This is the place to<br />
                                                    ...
                                                    Bring your own lunch or Get some other treat</div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="sample_school3">
                                            ...
                                            <div id="sample_schooltext3">
                                                <div class="sample_text">They'll call your mom when you go here for the clue<br />
                                        ...
                                        <div id="sample_school4">
                                            ...
                                            <div id="sample_schooltext4">
                                                <div class="sample_text">To go up and down,<br />
                                                    ...
                                                    Push a number on a button to stop at your floor.</div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="sample_playground1">
                                            ...
                                            <div id="sample_playtext1">
                                                <div class="sample_text">Back and forth like a pendulum it glides.<br />
                                                    Up into the air,<br />
                            ...
                            <div id="content_step3" align="left">
                                <div class="floatL" id="hide4">
                                    ...
                                    <div style="padding:16px 0px 14px 0px; width:585px;">
                                        <div class="arial14pxBlackB">Here is your treasure hunt, ready to print! If you want to change anything, click the buttons above to go back to the appropriate step. When you're ready, send the
                                            summary and clue sheets to your printer or download a PDF to print later.</div>
                                ...
                                <div class="paper_bg" style="width:774px; padding:10px; background-color:#ffffff;">
