			...
			function removeTextField(num,num2)
				...
				for (m=8; m>1; m--)
					...
					if (window['container_visible'+num][m]==true)
						...
						for (n=num2; n<m; n++)
							{
							document.formContainer('step1_description'+num+'_'+n).value=document.formContainer('step1_description'+num+'_'+(n+1)).value;
							}
						document.formContainer('step1_description'+num+'_'+m).value="";
						document.getElementById('container'+num+'_'+m).style.display="none";
			...
			function addTextField(num)
				...
				for (m=1; m<9; m++)
					...
					if (window['container_visible'+num][m]==false)
						...
						document.getElementById('container'+num+'_'+m).style.display="block";
						if (window['container_visible'+num][8]==true)
							{
							hideIt('add_textfield'+num);
							}
                                ...
                                <div class="box_240px">
                                    ...
                                    <div id="hide2" class="generator240_columnRM">
                                        ...
                                        <div id="sample_classroom1">
                                            <div id="sample_classtitle1" onclick="toggleClassroomText(1); return false;" class="sample_off"><div style="float:right; padding-right:36px; color:#ffffff;">Click to show clue.</div>Bookshelf<br clear="right" /></div>
                                            <div id="sample_classtext1">
                                                <div class="sample_text">The first place that<br />
                                                	You should look<br />
                                                	Is where you can<br />
                                                	Go to find a book.</div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="sample_classroom3">
                                            ...
                                            <div id="sample_classtext3">
                                                <div class="sample_text">The next clue<br />
                                        ...
                                        <div id="sample_classroom7">
                                            <div id="sample_classtitle7" onclick="toggleClassroomText(7); return false;" class="sample_off">Door</div>
                                            <div id="sample_classtext7">
                                                <div class="sample_text">I swing between<br />
                                                    The room and hall.<br />
                                                    I am not as wide<br />
                                                    As I am tall.</div>
                                        ...
                                        <div id="sample_classroom8">
                                            <div id="sample_classtitle8" onclick="toggleClassroomText(8); return false;" class="sample_off">Fishtank</div>
                                            <div id="sample_classtext8">
                                                <div class="sample_text">Four glass walls<br />
                                                    Are all around.<br />
                                                    If you don't have gills<br />
                                                    Then you will drown.</div>
                                            </div>
                                        </div>

                                        <div id="sample_classroom9">
                                            <div id="sample_classtitle9" onclick="toggleClassroomText(9); return false;" class="sample_off">Telephone</div>
                                        ...
                                        <div id="sample_classroom10">
                                            <div id="sample_classtitle10" onclick="toggleClassroomText(10); return false;" class="sample_off">Sink</div>
                                        ...
                                        <div id="sample_classroom11">
                                            <div id="sample_classtitle11" onclick="toggleClassroomText(11); return false;" class="sample_off">Projector</div>
                                        ...
                                        <div id="sample_classroom12">
                                            <div id="sample_classtitle12" onclick="toggleClassroomText(12); return false;" class="sample_off">Homework Bin</div>
                                        ...
                                        <div id="sample_classroom13">
                                            <div id="sample_classtitle13" onclick="toggleClassroomText(13); return false;" class="sample_off">Window</div>
                                        ...
                                        <div id="sample_school1">
                                            <div id="sample_schooltitle1" onclick="toggleSchoolText(1); return false;" class="sample_off2">Lunch Room</div>
                                        ...
                                        <div id="sample_school2">
                                            <div id="sample_schooltitle2" onclick="toggleSchoolText(2); return false;" class="sample_off2">Water Fountain</div>
                                        ...
                                        <div id="sample_school3">
                                            <div id="sample_schooltitle3" onclick="toggleSchoolText(3); return false;" class="sample_off2">Nurse's Office</div>
                                            <div id="sample_schooltext3">
                                                <div class="sample_text">They'll call your mom<br />
													When you go here for the clue<br />
                                                    If the mouth stick says<br />
                                                    One hundred and two.</div>
                                            </div>
                                        </div>
                                        <div id="sample_school4">
                                            <div id="sample_schooltitle4" onclick="toggleSchoolText(4); return false;" class="sample_off2">Elevator</div>
                                            <div id="sample_schooltext4">
                                                <div class="sample_text">To ride up and down,<br />
													Go in and close the door.<br />
                                        ...
                                        <div id="sample_playground1">
                                            <div id="sample_playtitle1" onclick="togglePlaygroundText(1); return false;" class="sample_off3">Swing</div>
                                        ...
                                        <div id="sample_playground2">
                                            <div id="sample_playtitle2" onclick="togglePlaygroundText(2); return false;" class="sample_off3">Slide</div>
